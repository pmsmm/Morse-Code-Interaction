...
// DOT LEDs
uint8_t ledDOT1 = 2;      // blink an led on output 12
uint8_t ledDOT2 = 3;      // blink an led on output 6
uint8_t ledDOT3 = 4;      // blink an led on output 12
uint8_t ledDOT4 = 5;      // blink an led on output 6

//DASH LEDs
uint8_t ledDASH1 = 9;     // blink an led on output 6
uint8_t ledDASH2 = 10;    // blink an led on output 12
uint8_t ledDASH3 = 11;

//START TRANSLATION TO MORSE BUTTON
uint8_t startButton = 13;  // Replay Morse Message

//PIEZZO SPEAKER
uint8_t audio8 = 12;       // output audio on pin 12
...
uint8_t elemPause = dotLen;  // length of the pause between elements of a character
uint16_t Spaces = dotLen * 3;     // length of the spaces between characters
uint16_t wordPause = dotLen * 7;  // length of the pause between words
